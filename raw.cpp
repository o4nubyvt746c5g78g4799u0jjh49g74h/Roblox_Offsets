...
constexpr std::uint32_t CurrentCamera: 0x3d8
...
constexpr std::uint32_t GameLoaded: 0x3c9
...
constexpr std::uint32_t TextLabelColor3: 0xb40
constexpr std::uint32_t TextLabelText: 0xa98
